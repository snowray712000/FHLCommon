...
public class BookNameConstants {
    /** @const {string[]} '創', '出', '利'... */
    public static let CHINESE_BOOK_ABBREVIATIONS = [
        "創", "出", "利", "民", "申",
    ...
    /** @const {string[]} '创', '出', '利',... */
    public static let CHINESE_BOOK_ABBREVIATIONS_GB = [
        "创", "出", "利", "民", "申",
    ...
    public static let CHINESE_BOOK_NAMES = [
    ...
    public static let CHINESE_BOOK_NAMES_GB = [
    ...
    public static let ENGLISH_BOOK_ABBREVIATIONS = [
    "Gen", "Ex", "Lev", "Num", "Deut",
    ...
    public static let ENGLISH_BOOK_NAMES = [
    ...
    public static let ENGLISH_BOOK_SHORT_ABBREVIATIONS = [
    "Ge", "Ex", "Le", "Nu", "De",
    "Jos", "Jud", "Ru", "1Sa", "2Sa",
